 ...
 *   https://datatables.net/download/#bs4/dt-2.1.8/date-1.5.4/fh-4.0.1/kt-2.12.1/r-3.0.3
 *
 * Included libraries:
 *   DataTables 2.1.8, DateTime 1.5.4, FixedHeader 4.0.1, KeyTable 2.12.1, Responsive 3.0.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs4/dt-2.1.8/date-1.5.4/fh-4.0.1/kt-2.12.1/r-3.0.3",
