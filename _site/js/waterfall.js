...
(function() {
  ...
  var demoContent = [
    {
      video: 'https://youtube.com/watch?v=ZWcxNAKuY9E',
    ...
    {
      video: 'https://youtube.com/watch?v=vl0ononypOQ',
    ...
    {
      video: 'https://youtube.com/watch?v=Pn1N_FfFE8s',
      gambar: 'https://i.ytimg.com/vi_webp/Pn1N_FfFE8s/hqdefault.webp',
      judul: 'cara hilangkan notif setelah pasang magisk',
      kateogri: 'Magisk',
      deskripsi:
        'Cara menghilangkan notifikasi magisk pada android.',
    },
    {
      video: 'https://youtube.com/watch?v=8b7ELH1VjIc',
...
function contentInit(content) {
  ...
  for (var i = 0; i < content.length; i++) {
      ...
      htmlArr.push('<a class="a-img" href="'+content[i].video+'">')
      if(content[i].gambar) {
        htmlArr.push('<img src="'+content[i].gambar+'" style="width: 100%">')
      }
      htmlArr.push('</a>')
      htmlArr.push('<h3 class="demo-title">')
      htmlArr.push('<a href="'+content[i].video+'">'+content[i].judul+'</a>')
      htmlArr.push('</h3>')
